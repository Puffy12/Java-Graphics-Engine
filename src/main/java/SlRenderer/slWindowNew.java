...
public class slWindowNew {
    ...
    private static slWindowNew my_window = null;
    ...
    public static slWindowNew get() {
        if (slWindowNew.my_window == null){
            slWindowNew.my_window = new slWindowNew();
        }
        return slWindowNew.my_window;
    }
